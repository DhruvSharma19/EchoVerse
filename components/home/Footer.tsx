            ...
            <div className='w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 py-24 flex flex-col sm:flex-row gap-10 justify-between'>
                ...
                <span className='font-bold text-2xl text-white'>Echoverse</span>
                    ...
                    <div className="flex items-center gap-4">
                        <a className="generic-hover" href="https://github.com/DhruvSharma19/EchoVerse">
                        <span className="sr-only cursor-pointer text-white">GitHub</span>
                ...
                <div className='flex flex-wrap sm:gap-x-12 gap-y-6 sm:mt-0'>
                    <div className='w-1/2 sm:w-auto'>
                        ...
                        <ul className='space-y-2'>
                            <li>
                                <a className="flex items-start button-hover " target="_self" href="/"><span className='cursor-pointer'>Getting Started</span></a>
                            </li>
                            <li>
                                <a className="flex items-start button-hover" target="_self" href="/" ><span className='cursor-pointer' >Guides</span></a>
                            </li>
                            <li>
                                <a className="flex items-start button-hover" target="_self" href="/"><span className='cursor-pointer' >API</span></a>
                            </li>
                        </ul>
                    </div>
                    <div className='w-1/2 sm:w-auto'>
                        ...
                        <ul className='space-y-2'>
                            <li>
                                <a className="flex items-start button-hover" target="_blank" href="">
                                    <span className='cursor-pointer'>Effectful</span>
                    ...
                    <div className='w-1/2 sm:w-auto'>
                        ...
                        <ul className='space-y-2'>
                            ...
                            <li>
                                <a className="flex items-start button-hover" target="_self" href="/"><span className='cursor-pointer'>Contact Us</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
